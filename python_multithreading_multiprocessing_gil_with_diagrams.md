...
![Sequential Execution vs Multithreading](diagram_sequential_vs_threads.png)
...
![Why join() Is Needed](diagram_join_method.png)
...
![Threads vs Processes: Memory Model](diagram_threads_vs_processes_memory.png)
...
![GIL Impact on CPU-Bound Threads](diagram_gil_cpu_bound.png)
